...
import type { Source, SourceType } from '@/types/knowledgeBase';
import { displayUrl, formatDateTime, formatRelative } from '@/utils';

const DEFAULTS = { q: '', type: '' } as const;
const COLUMNS = 5;
...
export function SourcesPage() {
  ...
  const resource = useResource(
    (signal) => knowledgeBaseApi.sources(knowledgeBase.id, { type: values.type as SourceType | '', search: values.q, page }, signal),
