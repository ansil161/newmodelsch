...
export function Panel({
  ...
  children: ReactNode;
  className?: string;
  /** No inner padding: for a table that runs to the panel's edges. */
  flush?: boolean;
  id?: string;
}) {
  return (
...
export function StatTile({ label, value, detail, tone }: { label: string; value: ReactNode; detail?: ReactNode; tone?: 'ok' | 'err' | 'busy' }) {
  return (
