...
function useFieldIds(explicit, hint, error) {
...
function Frame({ id, label, hint, error, optional, className, children }) {
  return (
...
export function TextField({ label, hint, error, optional, className, id: explicit, ...input }) {
...
export function TextArea({ label, hint, error, optional, className, id: explicit, ...input }) {
  const { id, describedBy } = useFieldIds(explicit, hint, error);
  return (
    <Frame id={id} label={label} hint={hint} error={error} optional={optional} className={className}>
      <textarea
...
export function SelectField({ label, hint, error, optional, className, id: explicit, children, ...select }) {
  const { id, describedBy } = useFieldIds(explicit, hint, error);
  return (
    <Frame id={id} label={label} hint={hint} error={error} optional={optional} className={className}>
