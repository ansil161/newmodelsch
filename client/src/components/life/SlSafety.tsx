...
function buildMotion(scope: HTMLElement) {
  ...
  mm.add(DESKTOP, () => {
    const measures = scope.querySelector<HTMLElement>('.sw__measures');
    const grid = scope.querySelector<HTMLElement>('.sw__grid');
    const arc = scope.querySelector<SVGPathElement>('.sw__ring-arc');
    const underline = scope.querySelector<SVGPathElement>('.sw__hand-line path');
  ...
  mm.add(MOBILE, () => {
    const visual = scope.querySelector<HTMLElement>('.sw__visual');
    const measures = scope.querySelector<HTMLElement>('.sw__measures');
...
export function SlSafety() {
  ...
  const toMeasures = (event: MouseEvent<HTMLAnchorElement>) => {
