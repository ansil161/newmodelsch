...
const METHOD = TEACHING_PRINCIPLES.map((principle, i) => ({
...
const outcome = (id) => LEARNING_STAGES.find((stage) => stage.id === id)?.outcome ?? '';
...
/* 03 - BEYOND THE SYLLABUS lives in `BeyondMap.jsx`. */

/* 04 - ACADEMIC PROOF lives in `AcademicProof.jsx`. */
