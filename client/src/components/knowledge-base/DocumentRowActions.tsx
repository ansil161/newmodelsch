...
import { availableActions, type DocumentActions } from './useDocumentActions';

/** A table row's actions. Nothing is offered to a viewer. */
export function DocumentRowActions({ document, actions, canEdit }: { document: KbDocument; actions: DocumentActions; canEdit: boolean }) {
