...
import type { ChatMetadata, ChatTurn, RagSource } from '@/types/knowledgeBase';
 ...
 */
export function ChatPanel({ knowledgeBaseId }: { knowledgeBaseId: string }) {
  ...
  const patch = (id: number, change: Partial<Message> | ((message: Message) => Partial<Message>)) =>
    setMessages((list) =>
...
function ChatMessage({ message, knowledgeBaseId }: { message: Message; knowledgeBaseId: string }) {
