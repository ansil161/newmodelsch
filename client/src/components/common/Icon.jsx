...
const PATHS = {
  ...
  trophy: (
    <>
      ...
      <path d="M7.5 6H4.5v1.5a3.5 3.5 0 0 0 3.2 3.5" />
      <path d="M16.5 6h3v1.5a3.5 3.5 0 0 1-3.2 3.5" />
      <path d="M12 14v3.5" />
      <path d="M8.5 20.5h7" />
      <path d="M9.5 20.5v-1.5a1.5 1.5 0 0 1 1.5-1.5h2a1.5 1.5 0 0 1 1.5 1.5v1.5" />
    </>
  ),
  sparkle: (
    <>
