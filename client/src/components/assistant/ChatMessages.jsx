 ...
 * not a conversation.
 */
export function ChatMessages({ mode, messages, pending, onSuggest }) {
  ...
  useEffect(() => {
    ...
    const node = el.querySelector('.fa-msg:last-of-type');
    const top =
...
function MessageItem({ message, speaker, animate }) {
