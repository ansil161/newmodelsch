...
export const CAMPUS_INTRO = {
  ...
  facts: [
    { value: '4', label: 'Acres', detail: 'Bahadurpura campus', icon: 'compass' },
    { value: '48', label: 'Classrooms', detail: 'All naturally lit', icon: 'landmark' },
    { value: '22,000', label: 'Library volumes', detail: 'Reading hall for 120', icon: 'book' },
    { value: '11', label: 'Laboratories', detail: 'Science, computing, robotics', icon: 'flask' },
  ],
