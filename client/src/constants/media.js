 ...
 *
 * Photography now resolves through `constants/imagery.js`, which is the one
 ...
 * takes a `Photo` from `imagery.js` and passes it to `Figure`, which is what
