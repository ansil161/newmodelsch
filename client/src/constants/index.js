...
export const HERITAGE_CHAPTERS = [
  {
    date: 'June 1962',
    headline:
 ...
 * `Journey.jsx` — and with it the two things it forced: a viewBox nobody could
...
export const ADMISSION_STEPS = ['Class', 'Details', 'Student', 'Schedule'];
